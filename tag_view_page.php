...
<div id="tag-view-div" class="form-container">
	...
	<div class="field-container">
		<span class="display-label"><span><?php echo _( 'Name' ) ?></span></span>
	...
	<div class="field-container">
		<span class="display-label"><span><?php echo _( 'Tag Description' ) ?></span></span>
	...
	<div class="field-container">
		<span class="display-label"><span><?php echo _( 'Related Tags' ); ?></span></span>
		...
		foreach( $t_tags_related as $t_tag ) {
			...
			$t_label = sprintf( _( 'Shared Issues (%1$s)' ), $t_tag['count'] ); ?>
			<tr>
	...
	<div class="action-buttons"><?php
		...
		<form class="action-button" action="tag_update_page.php" method="post">
			<fieldset>
				...
				<input type="submit" class="button" value="<?php echo _( 'Update Tag' ) ?>" />
			</fieldset>
		</form><?php
		}
		...
		<form action="tag_delete.php" method="post" class="action-button">
			<fieldset>
				...
				<input type="hidden" name="tag_id" value="<?php echo $f_tag_id ?>" />
				<input type="submit" class="button" value="<?php echo _( 'Delete Tag' ) ?>" />
			</fieldset>
		</form><?php
		} ?>
	</div><?php
