...
if ( $f_manage_page && $t_dst_project_id == ALL_PROJECTS && !user_is_administrator( auth_get_current_user_id() ) ) {
...
$t_redirect_url = $f_manage_page ? 'config_columns_page.php' : 'account_manage_columns_page.php';
