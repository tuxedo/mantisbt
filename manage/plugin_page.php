...
<tr class="row-category">
	<td><?php echo _( 'Plugin' ) ?></td>
	<td><?php echo _( 'Description' ) ?></td>
	<td><?php echo _( 'Dependencies' ) ?></td>
	<td><?php echo _( 'Priority' ) ?></td>
	<td><?php echo _( 'Protected' ) ?></td>
...
foreach ( $t_plugins_installed as $t_basename => $t_plugin ) {
	...
	if ( $t_upgrade ) { print_bracket_link( 'plugin_upgrade.php?name=' . $t_basename . form_security_param( 'manage_plugin_upgrade' ), _( 'Upgrade' ) ); }
	if ( $t_uninstall ) { print_bracket_link( 'plugin_uninstall.php?name=' . $t_basename . form_security_param( 'manage_plugin_uninstall' ), _( 'Uninstall' ) ); }
	echo '</td></tr>';
} ?>
...
foreach ( $t_plugins_available as $t_basename => $t_plugin ) {
	...
	echo '<td class="center">';
	if ( $t_ready ) { print_bracket_link( 'plugin_install.php?name=' . $t_basename . form_security_param( 'manage_plugin_install' ), _( 'Install' ) ); }
	echo '</td></tr>';
} ?>
