...
print_manage_menu( 'proj_page.php' );
...
<div class="form-container">
	...
	if ( access_has_global_level ( config_get( 'create_project_threshold' ) ) ) {
		print_button( 'proj_create_page.php', _( 'Create New Project' ) );
	} ?>

	<table cellspacing="1" cellpadding="5" border="1">
		<tr class="row-category">
			<td><?php
				print_manage_project_sort_link( 'proj_page.php', _( 'Name' ), 'name', $t_direction, $f_sort );
				print_sort_icon( $t_direction, $f_sort, 'name' ); ?>
			</td>
			<td><?php
				print_manage_project_sort_link( 'proj_page.php', _( 'Status' ), 'status', $t_direction, $f_sort );
			...
			<td><?php
				print_manage_project_sort_link( 'proj_page.php', _( 'View Status' ), 'view_state', $t_direction, $f_sort );
				print_sort_icon( $t_direction, $f_sort, 'view_state' ); ?>
			</td>
			<td><?php
				print_manage_project_sort_link( 'proj_page.php', _( 'Description' ), 'description', $t_direction, $f_sort );
...
<div id="categories" class="form-container">
	...
	<form method="post" action="proj_cat_add.php">
		<fieldset>
