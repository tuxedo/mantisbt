...
<div id="manage-proj-version-update-div" class="form-container">
	<form id="manage-proj-version-update-form" method="post" action="proj_ver_update.php">
		<fieldset>
			<legend><span><?php echo _( 'Edit Project Version' ) ?></span></legend>
			...
			<div class="field-container">
				<label for="proj-version-new-version"><span><?php echo _( 'Version' ) ?></span></label>
			...
			<div class="field-container">
				<label for="proj-version-date-order"><span><?php echo _( 'Date Order' ) ?></span></label>
			...
			<div class="field-container">
				<label for="proj-version-description"><span><?php echo _( 'Description' ) ?></span></label>
			...
			<div class="field-container">
				<label for="proj-version-released"><span><?php echo _( 'Released' ) ?></span></label>
			...
			<div class="field-container">
				<label for="proj-version-obsolete"><span><?php echo _( 'Obsolete' ) ?></span></label>
			...
			<span class="submit-button"><input type="submit" class="button" value="<?php echo _( 'Update Version' ) ?>" /></span>
		</fieldset>
	</form>
</div>
...
<div class="form-container">
	<form method="post" action="proj_ver_delete.php" class="action-button">
		<fieldset>
			...
			<input type="hidden" name="version_id" value="<?php echo string_attribute( $t_version->id ) ?>" />
			<input type="submit" class="button" value="<?php echo _( 'Delete Version' ) ?>" />
		</fieldset>
	</form>
</div>
