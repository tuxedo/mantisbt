...
function print_version_header( $p_version_row ) {
	...
	echo '<tt>';
	echo '<br />', $t_release_title, $t_scheduled_release_date, _( '&#32;' );
    print_bracket_link( 'view_all_set.php?type=1&amp;temporary=y&amp;' . FILTER_PROPERTY_PROJECT_ID . '=' . $t_project_id . '&amp;' . filter_encode_field_and_value( FILTER_PROPERTY_TARGET_VERSION, $t_version_name ), _( 'View Issues' ) );
    echo '<br />';
