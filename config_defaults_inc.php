 ...
 */
$MantisConfig->core_path = $MantisConfig->absolute_path . 'core/';

/**
 * absolute path to class files.  Requires trailing /
 * @global string $g_class_path
 */
$MantisConfig->class_path = $MantisConfig->core_path . 'classes/';

/**
 * absolute path to library files. Requires trailing /
 * @global string $g_library_path
 */
$MantisConfig->library_path = $MantisConfig->absolute_path . 'library/';

/**
 * absolute path to language files. Requires trailing /
 * @global string $g_language_path
 */
$MantisConfig->language_path = $MantisConfig->absolute_path . 'lang/';
 ...
 */
$MantisConfig->mailer_method = 'smtp';
 ...
 */
$MantisConfig->default_locale = 'en_US.UTF-8';
 ...
 */
$MantisConfig->file_upload_ftp_server = 'ftp.myserver.com';

/**
 *
 * @global string $g_file_upload_ftp_user
 */
$MantisConfig->file_upload_ftp_user = 'readwriteuser';

/**
 *
 * @global string $g_file_upload_ftp_pass
 */
$MantisConfig->file_upload_ftp_pass = 'readwritepass';
 ...
 */
$MantisConfig->html_valid_tags_single_line = 'i, b, u, em';
 ...
 */
$MantisConfig->ldap_server	= array( 'ldaps://ldap.example.com/', 
...
$MantisConfig->ldap_options = array();

/**
 * 
 * @global array $g_ldap_contexts
 */
$MantisConfig->ldap_contexts	= array( 'dc=example,dc=com' => true,
 ...
 */
$MantisConfig->ldap_realname_field  = 'displayName';

/**
 * The LDAP field for email name (i.e. email).
 * @global string $g_ldap_email_field
 */
$MantisConfig->ldap_email_field  = 'mail';
 ...
 */
$MantisConfig->show_attachment_indicator = OFF;
 ...
 */
$MantisConfig->set_status_threshold = array();
 ...
 */
$MantisConfig->anonymous_login = OFF;
 ...
 */
$MantisConfig->manage_cookie = '%cookie_prefix%_MANAGE_COOKIE';
 ...
 */
$MantisConfig->custom_field_type_enum_string = '0:string,1:numeric,2:float,3:enum,4:email,5:checkbox,6:list,7:multiselection list,8:date,9:radio';
 ...
 */
$MantisConfig->show_friendly_errors = OFF;
