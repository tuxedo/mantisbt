...
<tr class="print-category">
	<td class="print" width="16%">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_id ) ?>
	</td>
	<td class="print" width="16%">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_category ) ?>
	</td>
	<td class="print" width="16%">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_severity ) ?>
	</td>
	<td class="print" width="16%">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_reproducibility ) ?>
	</td>
	<td class="print" width="16%">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_date_submitted ) ?>
	</td>
	<td class="print" width="16%">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_last_update ) ?>
	</td>
</tr>
<tr class="print">
	<td class="print">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_reporter ) ?>
	</td>
	<td class="print">
		<?php print_user_with_subject( $t_bug->reporter_id, $t_id ) ?>
	</td>
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_platform ) ?>
	</td>
	<td class="print">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_assigned_to ) ?>
	</td>
	<td class="print">
		<?php
	...
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_os ) ?>
	</td>
	<td class="print">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_priority ) ?>
	</td>
	<td class="print">
		<?php echo get_enum_element( 'priority', $t_bug->priority ) ?>
	</td>
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_os_version ) ?>
	</td>
	<td class="print">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_status ) ?>
	</td>
	<td class="print">
		<?php echo get_enum_element( 'status', $t_bug->status ) ?>
	</td>
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_product_version ) ?>
	</td>
	<td class="print">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_product_build ) ?>
	</td>
	<td class="print">
		<?php echo string_display_line( $t_bug->build ) ?>
	</td>
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_resolution ) ?>
	</td>
	<td class="print">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_projection ) ?>
	</td>
	<td class="print">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_eta ) ?>
	</td>
	<td class="print">
		<?php echo get_enum_element( 'eta', $t_bug->eta ) ?>
	</td>
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_fixed_in_version ) ?>
	</td>
	<td class="print">
...
<tr class="print">
	...
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_target_version ) ?>
	</td>
	<td class="print">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), lang_get_defaulted( $t_def['name'] ) ) ?>
	</td>
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_summary ) ?>
	</td>
	<td class="print" colspan="5">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_description ) ?>
	</td>
	<td class="print" colspan="5">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_steps_to_reproduce ) ?>
	</td>
	<td class="print" colspan="5">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_additional_information ) ?>
	</td>
	<td class="print" colspan="5">
...
<tr class="print">
	<td class="print-category">
		<?php echo sprintf( _( '%1$s:' ), $t_lang_attached_files ) ?>
	</td>
	<td class="print" colspan="5">
		<?php
		...
		<tr>
			<td class="print">
				...
				<?php if ( $t_bugnote->date_submitted != $t_bugnote->last_modified ) {
					echo '<br />(' . lang_get( 'last_edited') . _( '&#32;' ) . $t_last_modified . ')';
				} ?>
			</td>
		</tr>
		</table>
